...
background_label.place(x=0, y=00)  # , relwidth=1, relheight=1)

label_l1 = tk.Label(root, text="Fake News Detection Using ML",font=("Times New Roman", 35, 'bold'),
                    background="#647C90", fg="black", width=55, height=1)
...
button1 = tk.Button(root, text="LOGIN", command=log, width=14, height=1,font=('times', 20, ' bold '), bg="#647C90", fg="white")
button1.place(x=20, y=190)

button2 = tk.Button(root, text="REGISTER",command=reg,width=14, height=1,font=('times', 20, ' bold '), bg="#647C90", fg="white")
